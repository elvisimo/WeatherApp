...
/**
 * Created by silend on 20.03.2015.
 */
...
public class TestDb extends AndroidTestCase {
    ...
    */
    public long testLocationTable() {
        ...
        TestUtilities.validateCurrentRecord("Location query validation fails",c,cv);
        assertFalse("More than 1 record returned",c.moveToNext());
        c.close();
        db.close();
        return row_id;
    ...
    public void testWeatherTable() {
        SQLiteDatabase db = new WeatherDbHelper(mContext).getWritableDatabase();
        ContentValues cv = TestUtilities.createWeatherValues(testLocationTable());
